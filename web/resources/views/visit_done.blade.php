...
@section('head')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('css/visit_done.css?0805v4') }}">
...
<section class="section-1">
	<div class="wrap">
		...
		<a href="http://hauoli-pm.com/all/allcategory/onestopdevelopmentsolution/developmentstory/576/" target="_blank">대면상담 안내사항 바로가기 &rarr;</a>
	</div>
</section>
@endsection